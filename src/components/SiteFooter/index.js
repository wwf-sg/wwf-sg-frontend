        ...
        <div className="row pt-5 mb-5">
          <div className="col-9 offset-1 col-md-5 offset-md-7 col-lg-4 offset-lg-8 col-xl-3 offset-xl-9">
            ...
            <a
              ...
              className="text-black d-inline-block m-2 link-facebook"
              target="_blank"
            ...
            <a
              ...
              className="text-black d-inline-block m-2 link-twitter"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              ...
              className="text-black d-inline-block m-2 link-instagram"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              ...
              className="text-black d-inline-block m-2 link-youtube"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              ...
              className="text-black d-inline-block m-2 link-linkedin"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
        ...
        <div className="row">
          <div className="col-12">
            <p>
              ...
              is a WWF Registered Trademark under the Creative Commons licence.
            </p>
          </div>
        </div>
      </div>
